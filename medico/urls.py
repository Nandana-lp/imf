...
urlpatterns = [
    ...
    path('transfer_patient/<int:id>', views.transfer_patient, name='transfer_patient'),
    path('transfer_patient_action/<int:patient_id>/<int:hosp_id>/', views.transfer_patient_action, name='transfer_patient_action'),
]